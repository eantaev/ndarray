...
public interface Array3d {
    ...
    default ImmutableArray3d toImmutable() {
        return this instanceof ImmutableArray3d
            ...
            : NdArrays.immutable3d.wrap(numberOfItems(), numberOfRows(), numberOfColumns(), readValues());
    ...
    default MutableArray3d toMutable() {
        return this instanceof MutableArray3d
            ? (MutableArray3d) this
            : NdArrays.mutable3d.wrap(numberOfItems(), numberOfRows(), numberOfColumns(), readValues());
    }
