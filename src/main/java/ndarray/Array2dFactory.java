...
public interface Array2dFactory<A extends Array2d> {
    ...
    A copyOf(int numberOfRows, int numberOfColumns, double[] data);

    A wrap(int numberOfRows, int numberOfColumns, double[] data);

    A generate(int numberOfRows, int numberOfColumns, IntIntToDoubleFunction generator);
}
