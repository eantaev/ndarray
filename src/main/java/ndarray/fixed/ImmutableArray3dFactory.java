...
final class ImmutableArray3dFactory implements Array3dFactory<ImmutableArray3d> {
    ...
    private static final class ImmutableZeroArray3d extends Array3dWithShape implements ImmutableArray3d {
        ...
        public ImmutableArray2d sliceAxis0(int item) {
            rangeCheck(item, numberOfItems());
            return FixedArrays.immutable2d.zeros(numberOfRows(), numberOfColumns());
        }

        @Override
        public ImmutableArray2d sliceAxis1(int row) {
            rangeCheck(row, numberOfRows());
            return FixedArrays.immutable2d.zeros(numberOfItems(), numberOfColumns());
        }

        @Override
        public ImmutableArray2d sliceAxis2(int col) {
            rangeCheck(col, numberOfColumns());
            return FixedArrays.immutable2d.zeros(numberOfItems(), numberOfRows());
        }
        ...
        public MutableArray3d toMutable() {
            return FixedArrays.mutable3d.zeros(numberOfItems(), numberOfRows(), numberOfColumns());
        }
    }
    ...
    private static final class ImmutableAllTheSameArray3d extends Array3dWithShape {
        ...
        @Override
        public ImmutableArray2d sliceAxis0(int item) {
            return FixedArrays.immutable2d.all(numberOfRows(), numberOfColumns(), value);
        }

        @Override
        public ImmutableArray2d sliceAxis1(int row) {
            return FixedArrays.immutable2d.all(numberOfItems(), numberOfColumns(), value);
        }

        @Override
        public ImmutableArray2d sliceAxis2(int col) {
            return FixedArrays.immutable2d.all(numberOfItems(), numberOfRows(), value);
        }
        ...
        @Override
        public MutableArray3d toMutable() {
            return FixedArrays.mutable3d.all(numberOfItems(), numberOfRows(), numberOfColumns(), value);
        }
    }
}
